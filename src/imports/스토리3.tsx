import svgPaths from "./svg-z1p3lyj1ts";
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="contents">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-between pt-[144px] relative size-full">
          <Top />
          <PageNation />
        </div>
      </div>
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[24px] size-full" data-name="스토리3">
      <MobileBrowserTop />
      <Contents />
      <MobileBrowserBottom />
    </div>
