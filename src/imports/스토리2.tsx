import svgPaths from "./svg-3rbr1y2tlm";
...
function Txtbox() {
  return (
    <div className="bg-[#f3f3f3] h-[141px] overflow-clip relative rounded-[14px] shrink-0 w-[197px]" data-name="txtbox">
      <p className="-translate-x-1/2 absolute font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[1.3] left-[calc(50%-0.5px)] text-[#030213] text-[16px] text-center top-[calc(50%-10.5px)] whitespace-nowrap">“ 수수께끼를 좋아하지 ”</p>
    </div>
  );
}
      ...
      <div className="absolute inset-[89.89%_3.94%_0_7.16%]">
        <div className="absolute inset-[-42.86%_-4.05%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 165.727 26.9307">
            <g filter="url(#filter0_f_1_366)" id="Ellipse 18">
              <ellipse cx="82.8636" cy="13.4653" fill="url(#paint0_linear_1_366)" fillOpacity="0.56" rx="76.6488" ry="7.25056" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="26.9307" id="filter0_f_1_366" width="165.727" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_1_366" stdDeviation="3.10738" />
              </filter>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_366" x1="6.21477" x2="159.512" y1="13.4653" y2="13.4653">
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[24px] size-full" data-name="스토리2">
      <MobileBrowserTop />
      <Skip />
      <Contents />
      <MobileBrowserBottom />
