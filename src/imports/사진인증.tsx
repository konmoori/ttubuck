import svgPaths from "./svg-bja3huqcmj";
...
function Span() {
  return (
    <div className="content-stretch flex h-[23.993px] items-center justify-center relative shrink-0" data-name="span">
      <p className="font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[19px] text-center text-white tracking-[-0.456px] whitespace-nowrap">목표물 발견 !</p>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[63.986px]" data-name="Icon">
...
function Notice() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="notice">
...
function Container2() {
  return (
    <div className="relative rounded-[36829000px] shrink-0 size-[63.986px]" data-name="Container">
...
function Button1() {
  return (
    <div className="bg-white h-[79.987px] relative rounded-[36829000px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Button">
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[24px] size-full" data-name="사진인증">
      <MobileBrowserTop />
      <Container />
      <Contents />
      <Container1 />
